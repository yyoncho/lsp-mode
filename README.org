...
** Why?
  - 💎 *Tested*: typed language, tested with CI.
  - 🚀 *Fast* -
  - 🌟 *Featured*: Almost 100% LSP support and
  - ❤️ *Flexible*
** Overview
   ...
   - Realtime Diagnostics/lint messages (via builtin ~flymake~ when Emacs > 26 or [[https://github.com/flycheck/flycheck][flycheck]]/[[https://github.com/emacs-lsp/lsp-ui][lsp-ui]])
