...
(lsp-register-client
 (make-lsp-client :new-connection (lsp-stdio-connection
                  ...
                  :initialization-options (list :storagePath "/home/kyoncho/.config/Code/User/workspaceStorage/bbd111bff66344859577ccea4ff2d51f/bmewburn.vscode-intelephense-client"
                                                :clearCache nil)
                  :multi-root t
                  :server-id 'iph))
